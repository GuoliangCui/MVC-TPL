    ...
    return function (e) {
        ...
        , function (e, t, n) {
            ...
            var r = n(4)
                ...
                , l = n(5)
                , d = i(l);
            a.call(d.default, navigator.userAgent),
                (0,
                    u.default)(d.default.fn, {
                        append: function (e) {
        ...
        , function (e, t, n) {
            ...
            function a() {
                ...
                return (0,
                    ...
                    r.default.getStyle(u[0], "transform"),
                    u.addClass(a ? "weui-animate-fade-in" : "weui-animate-slide-up"),
                    f.addClass("weui-animate-fade-in").on("click", e),
                    o.find(".weui-actionsheet__menu").on("click", ".weui-actionsheet__cell", function (n) {
                        var i = (0,
                            r.default)(this).index();
                ...
                o.onload = function (o) {
                    ...
                    r.onload = function () {
                        var o = n(r)
                            ...
                            , c = r.height
                            , p = void 0;
                        if (s < c && c > f ? (s = parseInt(f * r.width / r.height),
                            c = f) : s >= c && s > d && (c = parseInt(d * r.height / r.width),
                                s = d),
                            u.width = s,
                            u.height = c,
                            l.drawImage(r, 0, 0, s, c / o),
                            p = /image\/jpeg/.test(e.type) || /image\/jpg/.test(e.type) ? u.toDataURL("image/jpeg", t.compress.quality) : u.toDataURL(e.type),
                            "file" == t.type)
                            ...
                            /;base64,null/.test(p) || /;base64,$/.test(p) ? (t.onError(e, new Error("Compress fail, dataURL is " + p + ".")),
                                a()) : (e.base64 = p,
                                    a(e))
                    }
                        ,
        ...
        , function (e, t, n) {
            ...
            function o() {
                function e(n, i) {
                    ...
                    d.find(".weui-picker__group").eq(i).scroll({
                        ...
                        onChange: function (n, a) {
                            if (n ? r[i] = n.value : r[i] = null,
                                u[i] = a,
                                t)
                                o.onChange(r);
                            else if (n.children && n.children.length > 0)
                                d.find(".weui-picker__group").eq(i + 1).show(),
                                    !t && e(n.children, i + 1);
                            else {
                ...
                w[o.id] = w[o.id] || [];
                for (var r = [], u = w[o.id], d = (0,
                    l.default)(l.default.render(c.default, o)), s = a.depth || (t ? n.length : f.depthOf(n[0])), p = ""; s--;)
                    p += v.default;
            ...
            var d = n(26)
                ...
                , y = function (e) {
                    e.find(".weui-mask").addClass("weui-animate-fade-out"),
                        e.find(".weui-picker").addClass("weui-animate-slide-down").on("animationend webkitAnimationEnd", function () {
                            m(e)
                        })
                }
                , w = {};
        ...
        , function (e, t, n) {
            ...
            o.default.fn.scroll = function (e) {
                ...
                (0,
                    o.default)(this).find(".weui-picker__content").html(i);
                var a = (0,
                    o.default)(this).find(n.scrollable)
                    , c = void 0
                    , p = void 0
                    , v = void 0
                    , h = void 0
                ...
                a = (0,
                    o.default)(this).offAll().on("touchstart", function (e) {
        ...
        , function (e, t, n) {
            ...
            function a(e) {
                ...
                return (0,
                    ...
                    i.find(".weui-gallery__del").on("click", function () {
